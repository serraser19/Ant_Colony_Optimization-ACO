...
%        ALGORITHM  : MAX-MIN ANT SYSTEM (MMAS2) FOR TSP
%   MMAS2 : The exact length (Lexact) of the optimal tour is known
% ###################################################################
...
%            -->  Lexact   : Best Optimal solution known for the 
%                            respective instance

% Output     -->  sol : Optimal tour length
% """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

function sol = MMAS2_for_TSP(x,y,Maxit,num_Ants,alpha,beta,rho,Lexact)
...
tau_max = (rho*Lexact)^-1; % fixed for the entire algorithm
tau_min = tau_max/(2*num_Ants);
for i = 1:n
    for j = i+1:n
